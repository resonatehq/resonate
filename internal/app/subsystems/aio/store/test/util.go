			...
			},
			{
				...
				ReadPromise: &types.QueryPromisesResult{
					...
					Records: []*promise.PromiseRecord{{
						...
						State:                   1,
						ParamHeaders:            []byte("{}"),
						IdempotencyKeyForCreate: ikey("bar"),
						ParamData:               []byte{},
						Timeout:                 2,
						Tags:                    []byte("{}"),
						CreatedOn:               int64ToPointer(1),
			...
			},
			{
				...
				ReadPromise: &types.QueryPromisesResult{
					...
					Records: []*promise.PromiseRecord{{
						...
						State:                   1,
						ParamHeaders:            []byte("{}"),
						IdempotencyKeyForCreate: ikey("baz"),
						ParamData:               []byte("baz"),
						Timeout:                 3,
						Tags:                    []byte("{}"),
						CreatedOn:               int64ToPointer(1),
			...
			},
			{
				...
				ReadPromise: &types.QueryPromisesResult{
					...
					Records: []*promise.PromiseRecord{{
						...
						ValueHeaders:              []byte("{}"),
						ValueData:                 []byte{},
						IdempotencyKeyForComplete: ikey("foo"),
						Timeout:                   1,
						Tags:                      []byte("{}"),
						CreatedOn:                 int64ToPointer(1),
						CompletedOn:               int64ToPointer(2),
			...
			},
			{
				...
				ReadPromise: &types.QueryPromisesResult{
					...
					Records: []*promise.PromiseRecord{{
						...
						ValueHeaders:              []byte("{}"),
						ValueData:                 []byte{},
						IdempotencyKeyForComplete: ikey("bar"),
						Timeout:                   2,
						Tags:                      []byte("{}"),
						CreatedOn:                 int64ToPointer(1),
						CompletedOn:               int64ToPointer(2),
...
func ikey(s string) *promise.IdempotencyKey {
