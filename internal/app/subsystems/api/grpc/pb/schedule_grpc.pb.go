...
func (c *schedulesClient) ReadSchedule(ctx context.Context, in *ReadScheduleRequest, opts ...grpc.CallOption) (*ReadScheduleResponse, error) {
	...
	err := c.cc.Invoke(ctx, Schedules_ReadSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *schedulesClient) SearchSchedules(ctx context.Context, in *SearchSchedulesRequest, opts ...grpc.CallOption) (*SearchSchedulesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Schedules_SearchSchedules_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *schedulesClient) CreateSchedule(ctx context.Context, in *CreateScheduleRequest, opts ...grpc.CallOption) (*CreatedScheduleResponse, error) {
	...
	err := c.cc.Invoke(ctx, Schedules_CreateSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *schedulesClient) DeleteSchedule(ctx context.Context, in *DeleteScheduleRequest, opts ...grpc.CallOption) (*DeleteScheduleResponse, error) {
	...
	err := c.cc.Invoke(ctx, Schedules_DeleteSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSchedulesServer must be embedded to have
...
func (UnimplementedSchedulesServer) testEmbeddedByValue()                   {}
...
func RegisterSchedulesServer(s grpc.ServiceRegistrar, srv SchedulesServer) {
	// If the following call pancis, it indicates UnimplementedSchedulesServer was
