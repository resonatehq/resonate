...
That is an existential over the unobserved. `alts/unified/TRACES.md`
describes the same technique for `UTrace.tla`: "recovers arguments by
existential quantification, and post-state agreement selects the
witness."
