...
| 3 | `task.create id=b` | **this is the call that must be refused** |

**Violates** `NoDeadDispatch` at step 3.

The recorded prefix is in `traces/gen-dead-dispatch-claim.ndjson`; it stops
