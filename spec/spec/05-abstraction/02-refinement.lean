import «05-abstraction».«01-alpha»
import «03-equivalence».«05-refinement»
...
> quiescence. By the twins' bisimulation (`03-equivalence`), the same
...
Same alphabet and clock as `03-equivalence`, at length ≤ 3 — the
