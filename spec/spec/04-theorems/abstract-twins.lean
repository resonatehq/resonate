...
def handleAP (st : AStep) (now : Nat) : AbstractModel.H Response :=
  ...
  | .api (.promiseSettle req)           => Response.promiseSettle <$> AbstractModel.P.promiseSettle req now
  | .api (.promiseRegisterCallback req) => Response.promiseRegisterCallback <$> AbstractModel.P.promiseRegisterCallback req now
  | .api (.promiseRegisterListener req) => Response.promiseRegisterListener <$> AbstractModel.P.promiseRegisterListener req now
  | .api (.promiseSearch req)           => Response.promiseSearch <$> AbstractModel.P.promiseSearch req now
  | .api (.scheduleGet req)             => Response.scheduleGet <$> AbstractModel.P.scheduleGet req now
  | .api (.scheduleCreate req)          => Response.scheduleCreate <$> AbstractModel.P.scheduleCreate req now
  | .api (.scheduleDelete req)          => Response.scheduleDelete <$> AbstractModel.P.scheduleDelete req now
  | .api (.scheduleSearch req)          => Response.scheduleSearch <$> AbstractModel.P.scheduleSearch req now
  | .api (.taskGet req)                 => Response.taskGet <$> AbstractModel.P.taskGet req now
  | .api (.taskCreate req)              => Response.taskCreate <$> AbstractModel.P.taskCreate req now
  | .api (.taskAcquire req)             => Response.taskAcquire <$> AbstractModel.P.taskAcquire req now
  | .api (.taskFence req)               => Response.taskFence <$> AbstractModel.P.taskFence req now
  | .api (.taskHeartbeat req)           => Response.taskHeartbeat <$> AbstractModel.P.taskHeartbeat req now
  | .api (.taskSuspend req)             => Response.taskSuspend <$> AbstractModel.P.taskSuspend req now
  | .api (.taskFulfill req)             => Response.taskFulfill <$> AbstractModel.P.taskFulfill req now
  | .api (.taskRelease req)             => Response.taskRelease <$> AbstractModel.P.taskRelease req now
  | .api (.taskHalt req)                => Response.taskHalt <$> AbstractModel.P.taskHalt req now
  | .api (.taskContinue req)            => Response.taskContinue <$> AbstractModel.P.taskContinue req now
  | .api (.taskSearch req)              => Response.taskSearch <$> AbstractModel.P.taskSearch req now
  | .api _                              => return .τ
