...
def stepMutants : List (String × Bool) :=
  ...
  [ ("preserved_promise_birth_fields_immutable",
    ...
    ("preserved_settled_promise_record/state_moved",
       preserved_settled_promise_record 0 { objects := [objOf (oid "a") (S)] } { objects := [objOf (oid "a") ({ S with state := .rejected })] }),
    ...
    ("monotone_task_set_grows",
       monotone_task_set_grows 0 { objects := [objWith (oid "a") PT (T)] } { objects := [] }),
    ("monotone_task_version_increases_only_on_acquisition/bumped_without_acquiring",
       monotone_task_version_increases_only_on_acquisition 0 { objects := [objWith (oid "a") PT (T)] } { objects := [objWith (oid "a") PT ({ T with version := 4 })] }),
    ("monotone_task_version_increases_only_on_acquisition/acquired_without_bumping",
       monotone_task_version_increases_only_on_acquisition 0 { objects := [objWith (oid "a") PT (T)] } { objects := [objWith (oid "a") PT ({ A with version := 3 })] }),
    ...
    ("monotone_task_version_increases_only_on_acquisition/skipped_a_version",
       monotone_task_version_increases_only_on_acquisition 0 { objects := [objWith (oid "a") PT (T)] } { objects := [objWith (oid "a") PT ({ A with version := 5 })] }),
    ("monotone_task_version_increases_only_on_acquisition/reset_on_release",
       monotone_task_version_increases_only_on_acquisition 0 { objects := [objWith (oid "a") PT (A)] } { objects := [objWith (oid "a") PT ({ T with version := 0 })] }),
    ("preserved_fulfilled_task/resurrected",
       preserved_fulfilled_task 0 { objects := [objWith (oid "a") PT (F)] } { objects := [objWith (oid "a") PT (T)] }),
    ("preserved_fulfilled_task/regained_a_lease",
       preserved_fulfilled_task 0 { objects := [objWith (oid "a") PT (F)] } { objects := [objWith (oid "a") PT ({ F with pid := some "w" })] }),
    ("preserved_promise_state_frozen_once_settled",
       preserved_promise_state_frozen_once_settled 0 { objects := [objOf (oid "a") (S0)] } { objects := [objOf (oid "a") ({ S0 with state := .rejected })] }),
    ("preserved_promise_settlement_is_one_way",
       preserved_promise_settlement_is_one_way 0 { objects := [objOf (oid "a") (S0)] } { objects := [objOf (oid "a") (P)] }),
    ...
    ("monotone_promise_callbacks_grow_while_pending",
       monotone_promise_callbacks_grow_while_pending 0 { objects := [objOf (oid "a") ({ P with callbacks := [oid "x"] })] } { objects := [objOf (oid "a") (P)] }),
    ("monotone_promise_callbacks_shrink_once_settled",
       monotone_promise_callbacks_shrink_once_settled 0 { objects := [objOf (oid "a") (S0)] } { objects := [objOf (oid "a") ({ S0 with callbacks := [oid "x"] })] }),
    ("monotone_promise_listeners_grow_while_pending",
       monotone_promise_listeners_grow_while_pending 0 { objects := [objOf (oid "a") ({ P with listeners := ["https://a"] })] } { objects := [objOf (oid "a") (P)] }),
    ("monotone_promise_listeners_shrink_once_settled",
       monotone_promise_listeners_shrink_once_settled 0 { objects := [objOf (oid "a") (S0)] } { objects := [objOf (oid "a") ({ S0 with listeners := ["https://a"] })] }),
    ("consistent_promise_state_edge_admissible",
       consistent_promise_state_edge_admissible 0 { objects := [objOf (oid "a") (S0)] } { objects := [objOf (oid "a") ({ S0 with state := .rejected })] }),
    ("consistent_task_state_edge_admissible",
       consistent_task_state_edge_admissible 0 { objects := [objWith (oid "a") PT (T)] } { objects := [objWith (oid "a") PT ({ T with state := .suspended, retryTimeoutAt := none })] }),
    ("preserved_task_acquisition_only_from_pending",
       preserved_task_acquisition_only_from_pending 0 { objects := [objWith (oid "a") PT ({ T with state := .suspended, retryTimeoutAt := none })] } { objects := [objWith (oid "a") PT (A)] }),
    ("preserved_task_suspension_only_from_acquired",
       preserved_task_suspension_only_from_acquired 0 { objects := [objWith (oid "a") PT (T)] } { objects := [objWith (oid "a") PT ({ T with state := .suspended, retryTimeoutAt := none })] }),
    ("preserved_task_halted_only_reenters_via_pending",
       preserved_task_halted_only_reenters_via_pending 0 { objects := [objWith (oid "a") PT ({ T with state := .halted, retryTimeoutAt := none })] } { objects := [objWith (oid "a") PT ({ T with state := .suspended, retryTimeoutAt := none })] }),
    ("consistent_settlement_fulfils_task",
       consistent_settlement_fulfils_task 0 { objects := [objWith (oid "a") (PT) (T)] } { objects := [objWith (oid "a") (PTs) (T)] }),
    ("consistent_task_fulfilment_needs_settlement",
       consistent_task_fulfilment_needs_settlement 0 { objects := [objWith (oid "a") (PT) (T)] } { objects := [objWith (oid "a") (PT) ({ T with state := .fulfilled, retryTimeoutAt := none })] }),
    ("consistent_obligation_discharge_requires_settled",
       consistent_obligation_discharge_requires_settled 0 { objects := [objOf (oid "a") ({ P with callbacks := [oid "z"] })] } { objects := [objOf (oid "a") (P)] }),
    ("consistent_callback_consumption_resumes_awaiter",
       consistent_callback_consumption_resumes_awaiter 0
         { objects := [objOf (oid "c") ({ P with callbacks := [oid "a"] }), objWith (oid "a") PT (T)] }
         { objects := [objOf (oid "c") ({ P with state := .resolved, settledAt := some 20 }), objWith (oid "a") PT (T)] }),
    ("consistent_listener_consumption_enqueues_unblock",
       consistent_listener_consumption_enqueues_unblock 0 { objects := [objOf (oid "a") ({ S0 with listeners := ["https://l"] })] } { objects := [objOf (oid "a") (S0)] }),
    ("consistent_wake_follows_callback_consumption",
       consistent_wake_follows_callback_consumption 0
         { objects := [objOf (oid "c") ({ P with callbacks := [oid "a"] }), objWith (oid "a") PT ({ T with state := .suspended, retryTimeoutAt := none })] }
         { objects := [objOf (oid "c") ({ P with callbacks := [oid "a"] }), objWith (oid "a") PT ({ T with state := .pending, retryTimeoutAt := some 30 })] }),
    ("consistent_suspension_registers_callback",
       consistent_suspension_registers_callback 0 { objects := [objWith (oid "a") (P) (A)] } { objects := [objWith (oid "a") (P) ({ A with state := .suspended, pid := none, ttl := none, leaseTimeoutAt := none })] }),
    ("consistent_task_birth_couples_promise_birth",
       consistent_task_birth_couples_promise_birth 0 { } { objects := [objWith (oid "a") PT (T)] }),
    ...
    ("consistent_new_execute_matches_task_and_target",
       consistent_new_execute_matches_task_and_target 0 { objects := [objWith (oid "a") (PT) (T)] } { objects := [objWith (oid "a") (PT) (T)], outbox := [{ address := "wrong", message := .execute (oid "a") 3 }] }),
    ("consistent_new_unblock_carries_stored_record",
       consistent_new_unblock_carries_stored_record 0 { objects := [objOf (oid "a") (P)] } { objects := [objOf (oid "a") (P)], outbox := [{ address := "https://l", message := .unblock (P.toRecord (oid "a")) }] }),
    ("consistent_new_unblock_discharges_its_listener",
       consistent_new_unblock_discharges_its_listener 0
         { objects := [objOf (oid "a") ({ S0 with listeners := ["https://l"] })] }
         { objects := [objOf (oid "a") ({ S0 with listeners := ["https://l"] })], outbox := [{ address := "https://l", message := .unblock (S0.toRecord (oid "a")) }] }),
    ...
    ("consistent_promise_settlement_stamp/forged_timeout",
       consistent_promise_settlement_stamp 50 { objects := [objOf (oid "a") (P)] } { objects := [objOf (oid "a") ({ P with state := .rejectedTimedout, settledAt := some 50 })] }),
    ("consistent_promise_settlement_stamp/verdict_before_deadline",
       consistent_promise_settlement_stamp 50 { objects := [objOf (oid "a") (P)] } { objects := [objOf (oid "a") ({ P with state := .resolved, settledAt := some 100 })] }),
    ("preserved_timedout_is_server_owned",
       preserved_timedout_is_server_owned 500 { objects := [objOf (oid "a") (P)] } { objects := [objOf (oid "a") ({ P with state := .rejectedTimedout, settledAt := some 500 })] }),
    ...
    ("consistent_task_lease_released_atomically",
       consistent_task_lease_released_atomically 0 { objects := [objWith (oid "a") PT (A)] } { objects := [objWith (oid "a") PT ({ T with version := 4, pid := some "w" })] }),
    ("preserved_task_lease_holder_stable",
       preserved_task_lease_holder_stable 0 { objects := [objWith (oid "a") PT (A)] } { objects := [objWith (oid "a") PT ({ A with pid := some "w2" })] }),
    ("consistent_task_lease_fields_move_together",
       consistent_task_lease_fields_move_together 0 { objects := [objWith (oid "a") PT (A)] } { objects := [objWith (oid "a") PT ({ A with ttl := some 50 })] }),
    ("monotone_task_resumes_grow_or_clear",
       monotone_task_resumes_grow_or_clear 0 { objects := [objWith (oid "a") PT ({ T with resumes := [oid "b"] })] } { objects := [objWith (oid "a") PT ({ T with resumes := [oid "c"] })] }),
    ("consistent_task_resumes_cleared_only_on_dispatch_or_park",
       consistent_task_resumes_cleared_only_on_dispatch_or_park 0 { objects := [objWith (oid "a") PT ({ A with resumes := [oid "b"] })] } { objects := [objWith (oid "a") PT ({ T with version := 4 })] }),
    ("consistent_task_acquisition_is_atomic",
       consistent_task_acquisition_is_atomic 40 { objects := [objWith (oid "a") PT (T)] } { objects := [objWith (oid "a") PT (A)] }),
    ("consistent_task_lease_deadline_is_now_plus_ttl",
       consistent_task_lease_deadline_is_now_plus_ttl 40 { objects := [objWith (oid "a") PT (A)] } { objects := [objWith (oid "a") PT ({ A with leaseTimeoutAt := some 999 })] }),
    ("consistent_task_pending_entry_arms_retry",
       consistent_task_pending_entry_arms_retry 7 { objects := [objWith (oid "a") PT (A)] } { objects := [objWith (oid "a") PT ({ T with version := 4, retryTimeoutAt := none })] }),
    ("consistent_task_retry_rearm_only_when_due",
       consistent_task_retry_rearm_only_when_due 5 { objects := [objWith (oid "a") PT ({ T with retryTimeoutAt := some 50 })] } { objects := [objWith (oid "a") PT ({ T with retryTimeoutAt := some 900 })] }),
    ("consistent_task_wake_records_resume",
       consistent_task_wake_records_resume 7 { objects := [objWith (oid "a") PT ({ T with state := .suspended, retryTimeoutAt := none })] } { objects := [objWith (oid "a") PT ({ T with retryTimeoutAt := some 7 })] }),
    ("consistent_task_state_edge_internal_admissible",
       consistent_task_state_edge_internal_admissible 0 { objects := [objWith (oid "a") PT (T)] } { objects := [objWith (oid "a") PT (A)] }),
    ("consistent_promise_state_edge_internal_admissible",
       consistent_promise_state_edge_internal_admissible 0 { objects := [objOf (oid "a") (P)] } { objects := [objOf (oid "a") ({ P with state := .resolved, settledAt := some 20 })] }),
    ("preserved_no_dead_dispatch",
       preserved_no_dead_dispatch 500
         { objects := [objWith (oid "a") (P) ({ T with state := .acquired, pid := some "w", ttl := some 1, leaseTimeoutAt := some 1, retryTimeoutAt := none })] }
         { objects := [objWith (oid "a") (P) (T)] }),
    ("preserved_execute_only_for_live_task",
       preserved_execute_only_for_live_task 500
         { objects := [objOf (oid "a") (P)] }
         { objects := [objOf (oid "a") (P)], outbox := [{ address := "w", message := .execute (oid "a") 3 }] }) ]
