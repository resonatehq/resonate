...
def test_run(
    ...
    assert math.isclose((promise.timeout - promise.created_on) / 1000, default_opts.timeout, rel_tol=0.1)
    ...
    assert promise.param.data == {"func": name, "args": list(args), "kwargs": kwargs, "version": version or 1}
    assert math.isclose((promise.timeout - promise.created_on) / 1000, default_opts.timeout, rel_tol=0.1)
    assert math.isclose((promise.timeout - promise.created_on) / 1000, default_conv.timeout, rel_tol=0.1)
    ...
    assert promise.param.headers == {}
    assert promise.param.data == {"func": name, "args": list(args), "kwargs": kwargs, "version": version or 1}
    assert math.isclose((promise.timeout - promise.created_on) / 1000, updated_opts.timeout, rel_tol=0.1)
    ...
    assert promise.param.data == {"func": name, "args": list(args), "kwargs": kwargs, "version": version or 1}
    assert math.isclose((promise.timeout - promise.created_on) / 1000, updated_opts.timeout, rel_tol=0.1)
    assert math.isclose((promise.timeout - promise.created_on) / 1000, updated_conv.timeout, rel_tol=0.1)
